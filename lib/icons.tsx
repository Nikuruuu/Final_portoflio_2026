/**
 * Inline SVG brand icons — lucide-react dropped these in recent versions.
 * Use these instead of importing from lucide-react for brand logos.
 */
...
export const XTwitterIcon = ({ size = 20, className }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
